# Exemplo de aplicação 5: Elabore um programa que faça uso de uma tupla chamada Endereco, contendo dados nomeados.


# Para o uso da função namedtuples, é necessário importar a função, fazendo uso de:
